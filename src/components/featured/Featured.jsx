  ...
  return (
    <div className='featured'>
        ...
        <div className="info">
            ...
            <span className='desc'>
                hfewjni;oflhenmwgrjklnmwrgilkn;oitehlkfbnetioglfnko;iethg
                j;rwbgnio;ersgneriosgnetkhlbnetf
                erbjnet;dlnkgtekdfl/hgnielfknbetdff
                w;rkughwo;4ghrn;oishgnwro;ihg;roihgerg
            </span>
